#!/usr/bin/env python3
"""Measures the two SwarmLoRA cold-start numbers in Fig. 6: sequential worker
...
async def benchmark_spawn(
    ...
    """Measure sequential worker spawn (Fig. 6 'spawn' bar).
...
async def benchmark_swap(
    ...
    # --- Sequential swaps (Fig. 6 'hot swap' bar) ---
